...
TextStyle labelStyle3 = GoogleFonts.cairo(
  textStyle:const  TextStyle(
      fontSize: 15, fontWeight: FontWeight.w600, height: 1, color: black),
);
...
TextStyle hintStyle3 = GoogleFonts.cairo(
  textStyle: const TextStyle(
      fontSize: 13, fontWeight: FontWeight.w400, height: 1.5, color: gray),
);

TextStyle hintStyle4 = GoogleFonts.cairo(
  textStyle:const TextStyle(
      fontSize: 12, fontWeight: FontWeight.bold, height: 1.5, color: black),
);
TextStyle hintStyle5 = GoogleFonts.cairo(
  textStyle: const TextStyle(
      fontSize: 10, fontWeight: FontWeight.bold, height: 1.5, color: black),
);


TextStyle submitButtonStyle= GoogleFonts.cairo(
    fontSize: 18,
    color: white,
    fontWeight: FontWeight.w600
);
TextStyle submitButtonStyle2= GoogleFonts.cairo(
    fontSize: 15,
    color: white,
    fontWeight: FontWeight.w600
);
